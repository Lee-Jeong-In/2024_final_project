                    ...
                    Obx(() {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: percent <= 33.3 ? Colors.green : percent >= 66.6 ? Colors.red : Colors.yellow
                        ),
                        child: Text(percent <= 33.3 ? "원활" : percent >= 66.6 ? "혼잡" : "보통", style: const TextStyle(color: Colors.white),),
                      );
                    },),
                  ],
                );
